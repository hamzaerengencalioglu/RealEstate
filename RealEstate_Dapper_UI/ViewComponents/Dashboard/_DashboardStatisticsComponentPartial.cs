...
namespace RealEstate_Dapper_UI.ViewComponents.Dashboard
{
    public class _DashboardStatisticsComponentPartial : ViewComponent
    {
        ...
        {
            #region Statistics1 - TotalNumberOfListings
            ...
            #region Statistics2 - MostSuccessfulEmployee
            ...
            #region Statistics3 - NumberOfCitiesInListings
            ...
            #region Statistics4 - AverageRentPrice
            var client4 = _httpClientFactory.CreateClient();
            var responseMessage4 = await client4.GetAsync("https://localhost:44358/api/Statistics/DifferentCityCount");
